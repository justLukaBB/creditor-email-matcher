...
async def process_incoming_email(email_id: int = None, webhook_data: ZendeskWebhookEmail = None):
    ...
    try:
        ...
        if client_name and (creditor_name or creditor_email) and new_debt_amount:
            ...
            # Update MongoDB directly with extracted data
            ...
            # Update MongoDB with new debt amount
            mongodb_update_success = mongodb_service.update_creditor_debt_amount(
                ...
                creditor_name=creditor_name_or_email,  # Use email as fallback
